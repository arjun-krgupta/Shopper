...
import { allRealme } from '../../Constant/allMobile';

function Realme(props) {
    ...
    return (
        <>
         ...
         <div className='w-full h-auto'>
            <h1 className='font-bold text-4xl mt-3 mb-1 text-center'>Realme Phones</h1>
              <img src={sl1} alt="" className='max-w-100 h-auto'/>
              <img src={sl2} alt="" className='max-w-100 h-auto'/>
         </div>
        <div>
            {
                allRealme.map((val,ind)=>
            ...
            <div className="w-36 image sm:w-[19%] md:w-[17%] lg:w-[12%] ">
