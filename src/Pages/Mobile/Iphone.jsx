...
import { allIphone } from '../../Constant/allMobile';
    ...
    return (
        <>
         ...
         <div className='w-full h-auto'>
            <h1 className='font-bold text-4xl mt-3 mb-1 text-center'>Apple Phones</h1>
              <img src={sl1} alt="" className='max-w-100 h-auto'/>
              <img src={sl2} alt="" className='max-w-100 h-auto'/>
         </div>
        <div>
            {
                allIphone.map((val,ind)=>
                    <div className="flex justify-center gap-3 sm:gap-6 md:gap-16 bg-white p-3 pb-3 border-bottom mb-2 w-full cursor-pointer" key={ind}>
                <div className="w-36 image sm:w-[19%] md:w-[17%] lg:w-[10%] ">
