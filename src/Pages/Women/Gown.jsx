...
function Gown() {
  return (
    <>
      <div className="flex justify-center gap-2 flex-wrap overflow-x-scroll webkit w-full mt-4 mb-2 px-2 sm:px-28 md:px-40 lg:px-48">
        {allGown.map((val, i) => (
          <div
            className="flex relative flex-col hover:rounded hover:shadow-xl hover:bg-transparent hover:transition-[0.2s] hover:scale-[1.03] items-center gap-1 my-2 py-2 px-3 w-[170px] sm:w-44 md:w-56 rounded-md shadow-md"
            key={i}
          >
