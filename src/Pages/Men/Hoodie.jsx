  ...
  return (
    <>
      <div className="flex justify-center gap-3 flex-wrap overflow-x-scroll webkit w-full my-4 px-4 sm:px-14 md:px-16">
        {allHoodie.map((val, i) => (
          <div
            className="flex relative flex-col hover:rounded hover:shadow-xl hover:bg-transparent hover:transition-[0.2s] hover:scale-[1.03] items-center gap-1 my-2 py-2 w-32 sm:w-44 md:w-52"
            key={i}
          >
